export { default as EmailPassword } from './FormEmailPassword';
export { default as PersonInfo } from './FormPersonInfo';
export { default as DriverInfo } from './FormDriverInfo';
...
export { default as VerificationCode } from './FormVerificationCode'
