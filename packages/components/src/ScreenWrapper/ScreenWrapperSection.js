...
export const ScreenWrapperSection = ({ withPaddingHorizontal = false, title, description, titleStyle, style, children }) => (
    <ScreenWrapperContainer
        ...
        {description ? (
            <>
                {title ? <List.Subheader style={[{ paddingHorizontal: 0, paddingBottom: 0 }, titleStyle]}>{title}</List.Subheader> : null}
                <Text
                    selectable={false}
                    style={{
