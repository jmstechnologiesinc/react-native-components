...
const PhotoGallery = ({ photos, onChange, isDisabled }) => (
    <ScreenWrapper.Section title={localized('photos')}>
        <DraggablePhotoGallery photos={photos} onChange={onChange} isDisabled={isDisabled} />
        <ImagePicker
            variant="button"
            title={localized('add')}
        ...
        <HelperText padding="none">{localized('itemPhotoRequirements')}</HelperText>
        <HelperText padding="none">{localized('photoGalleryRearrange')}</HelperText>
