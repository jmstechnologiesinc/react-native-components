...
export const VendorDriverRejected = () =>
    renderOrderListItem({ ...vendorMockData[1], status: ORDER_STATUS.driverRejected });
export const VendorDriverPending = () =>
    renderOrderListItem({ ...vendorMockData[1], status: ORDER_STATUS.driverPending });
...
export const DriverDriverAccepted = () =>
    renderOrderListItem(
        { ...vendorMockData[3], status: ORDER_STATUS.driverAccepted, deliveryMethod: DELIVERY_METHODS.marketPlace },
        null,
        'driver'
    );
export const DriverDriverRejected = () =>
    renderOrderListItem({ ...vendorMockData[1], status: ORDER_STATUS.driverRejected }, null, 'driver');
export const DriverDriverPending = () =>
    renderOrderListItem({ ...vendorMockData[1], status: ORDER_STATUS.driverPending }, null, 'driver');
export const DriverDriverShipped = () =>
    renderOrderListItem({ ...vendorMockData[1], status: ORDER_STATUS.shipped }, null, 'driver');

export const CustomerNew = () =>
    renderOrderListItem({ ...vendorMockData[0], status: ORDER_STATUS.placed }, null, 'customer');
export const CustomerNewPickup = () =>
    renderOrderListItem(
        {
            ...vendorMockData[0],
            status: ORDER_STATUS.placed,
...
export const CustomerriverAccepted = () =>
    renderOrderListItem(
        { ...vendorMockData[3], status: ORDER_STATUS.driverAccepted, deliveryMethod: DELIVERY_METHODS.marketPlace },
        null,
        'customer'
    );
export const CustomerPickupComplete = () =>
    renderOrderListItem(
        { ...vendorMockData[2], deliveryMethod: PICKUP_METHODS.customerPickup, deliveryOption: PUB.pickup },
        null,
        'customer'
    );
export const CustomerPickupAccepted = () =>
    renderOrderListItem(
        {
            ...vendorMockData[1],
            status: ORDER_STATUS.restaurantAccepted,
...
export const CustomerPickupReadyForPickup = () =>
    renderOrderListItem(
        {
            ...vendorMockData[1],
            status: ORDER_STATUS.readyforPickup,
...
export const CustomerDriverRejected = () =>
    renderOrderListItem({ ...vendorMockData[1], status: ORDER_STATUS.driverRejected }, null, 'customer');
export const CustomerDriverPending = () =>
    renderOrderListItem({ ...vendorMockData[1], status: ORDER_STATUS.driverPending }, null, 'customer');
export const CustomerDriverShipped = () =>
    renderOrderListItem({ ...vendorMockData[1], status: ORDER_STATUS.shipped }, null, 'customer');
