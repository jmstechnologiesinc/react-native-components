...
import overlay, { isAnimatedValue } from './overlay';
...
const Surface = ({ elevation = 1, children, style, ...props }: Props) => {
    ...
    if (Platform.OS === 'android') {
        ...
        const { margin, padding, transform, borderRadius } = StyleSheet.flatten(style) as ViewStyle;
