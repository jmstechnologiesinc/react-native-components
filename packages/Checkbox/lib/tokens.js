...
exports.MD3Colors = exports.tokens = exports.typescale = void 0;
...
var ref = {
    ...
    typeface: {
        brandRegular: react_native_1.Platform.select({
            web: 'Roboto, "Helvetica Neue", Helvetica, Arial, sans-serif',
            ios: 'System',
            default: 'sans-serif',
        }),
        weightRegular: '400',
        plainMedium: react_native_1.Platform.select({
            web: 'Roboto, "Helvetica Neue", Helvetica, Arial, sans-serif',
            ios: 'System',
...
exports.typescale = {
    displayLarge: __assign(__assign({}, regularType), { lineHeight: 64, fontSize: 57 }),
    displayMedium: __assign(__assign({}, regularType), { lineHeight: 52, fontSize: 45 }),
    displaySmall: __assign(__assign({}, regularType), { lineHeight: 44, fontSize: 36 }),
    headlineLarge: __assign(__assign({}, regularType), { lineHeight: 40, fontSize: 32 }),
    headlineMedium: __assign(__assign({}, regularType), { lineHeight: 36, fontSize: 28 }),
    headlineSmall: __assign(__assign({}, regularType), { lineHeight: 32, fontSize: 24 }),
    titleLarge: __assign(__assign({}, regularType), { lineHeight: 28, fontSize: 22 }),
    titleMedium: __assign(__assign({}, mediumType), { lineHeight: 24, fontSize: 16 }),
    titleSmall: __assign(__assign({}, mediumType), { letterSpacing: 0.1, lineHeight: 20, fontSize: 14 }),
    labelLarge: __assign(__assign({}, mediumType), { letterSpacing: 0.1, lineHeight: 20, fontSize: 14 }),
    labelMedium: __assign(__assign({}, mediumType), { letterSpacing: 0.5, lineHeight: 16, fontSize: 12 }),
    labelSmall: __assign(__assign({}, mediumType), { letterSpacing: 0.5, lineHeight: 16, fontSize: 11 }),
    bodyLarge: __assign(__assign({}, mediumType), { fontWeight: ref.typeface.weightRegular, fontFamily: ref.typeface.brandRegular, lineHeight: 24, fontSize: 16 }),
    bodyMedium: __assign(__assign({}, mediumType), { fontWeight: ref.typeface.weightRegular, fontFamily: ref.typeface.brandRegular, letterSpacing: 0.25, lineHeight: 20, fontSize: 14 }),
    bodySmall: __assign(__assign({}, mediumType), { fontWeight: ref.typeface.weightRegular, fontFamily: ref.typeface.brandRegular, letterSpacing: 0.4, lineHeight: 16, fontSize: 12 }),
};
exports.tokens = {
    md: {
        ref: ref,
        sys: {
            typescale: exports.typescale,
        },
    },
};
exports.MD3Colors = ref.palette;
