...
var LightTheme = {
    ...
    colors: {
        ...
        surfaceDisabled: (0, color_1.default)(palette.neutral10).alpha(opacity.level2).rgb().string(),
        ...
        onSurfaceDisabled: (0, color_1.default)(palette.neutral10).alpha(opacity.level4).rgb().string(),
